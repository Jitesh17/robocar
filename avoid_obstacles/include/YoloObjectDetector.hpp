...
#include <std_msgs/Empty.h>//bebop topic need
#include <geometry_msgs/Twist.h>//bebop topic need
...
#include <avoid_obstacles/BoundingBox.h>
#include <avoid_obstacles/CheckForObjectsAction.h>
...
extern "C" void image_into_ipl(image im,IplImage * dst);//add 20181012

#define OPENCV_DETECT //配合使用opencv目标颜色追踪 20181012
#define BEBOP_CONTROL //使能控制parrot无人机 20181013
...
class YoloObjectDetector
{
 ...
 private:
  ...
  //bebop control Pubuilsher & data struct 20181013
  ...
  void *opencvdetectInThread();//add 20181011

  void *opencv_detectThread(void *ptr);//add 20181011
